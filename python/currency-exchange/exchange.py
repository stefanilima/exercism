...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread = (1.0 + spread / 100)
    money = exchange_money(budget, exchange_rate * spread)
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money = exchange_money(budget, exchange_rate * (1.0 + spread / 100))
    exchangeable = exchangeable_value(budget, exchange_rate, spread, denomination)
    return int(money - exchangeable)